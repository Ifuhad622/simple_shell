 ...
 * Return: 0 on success.  if no numbers in string, converted the number otherwise
 *       -1 on error
 */
int _erratoi(char *s)
{
 ...
 * Return: 0 if no numbers is in string, converted the number otherwise
 *        -1 on error
 */
 ...
 *
 * Return: number of a characters printed
 */
...
/**
 * convert_number - converter a function, a clone of itoa
 * @num: number
 * @base: base
