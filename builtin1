 ...
 * @info: Struct containing potential argu. Used to maintain
...
/**
 * _myalias - mimics an alias builtin (man alias)
 * @info: Struct containing a potential arguments. Used to maintain
 *          the constant function prototype.
 *  Return: 0 Always 
 */
